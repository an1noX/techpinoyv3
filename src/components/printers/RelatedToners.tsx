          ...
          <CardContent className="p-0">
            <div className="flex flex-col sm:flex-row">
              ...
              <div className="flex-1 p-4">
                <h4 className="font-medium text-sm mb-1 group-hover:text-techblue-600 transition-colors">{toner.name}</h4>
              ...
              <div className="p-4 text-right border-t sm:border-t-0 sm:border-l bg-gray-50 group-hover:bg-blue-50 transition-colors">
                <div className="text-lg font-bold text-red-500">
                  ₱{toner.price?.toFixed(2) || "19.95"}
                </div>
                <div className="text-xs text-gray-500 line-through">
                  ₱{((toner.price || 19.95) * 1.3).toFixed(2)}
                </div>
